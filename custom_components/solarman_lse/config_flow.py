...
def step_user_data_schema(data: dict[str, Any] = {CONF_NAME: SENSOR_PREFIX, CONF_INVERTER_PORT: DEFAULT_PORT_INVERTER, CONF_INVERTER_MB_SLAVEID: DEFAULT_INVERTER_MB_SLAVEID, CONF_LOOKUP_PROTOCOL: DEFAULT_LOOKUP_PROTOCOL, CONF_LOOKUP_FILE: DEFAULT_LOOKUP_FILE}) -> Schema:
